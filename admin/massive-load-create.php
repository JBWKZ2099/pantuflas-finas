...
ini_set("display_errors", "On");
	...
	if( authCheck() && userAccess()["catalogue"]==1 ) {
		$mysqli = conectar_db();
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	<?php
		$active_menu = "masload_mn";
		$collapse = "masload";
		$active_opt = "masload-create";
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form action="../php/db/requests.php" method="POST" enctype="multipart/form-data">
									<input type="hidden" name="request" value="create-masload">
									<input type="hidden" name="table" value="masload">
									<?php include("forms/masload-form.php") ?>
